...
// A dependency of AlertRuleBuilder uses CJS require() which Turbopack does not
...
const AlertRuleBuilder = dynamic(
  () => import('./AlertRuleBuilder').then((m) => m.AlertRuleBuilder),
  { loading: () => <Spinner size="lg" />, ssr: false },
);

export function AlertRuleBuilderLoader() {
