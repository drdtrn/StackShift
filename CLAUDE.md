...
- New columns or tables that hold personal data must be added to `docs/pii-inventory.md` in the same commit (Confidential or Restricted class) — the privacy policy and DPA reference that file verbatim.
